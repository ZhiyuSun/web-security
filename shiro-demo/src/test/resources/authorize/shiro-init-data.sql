...
insert into users(username, password, password_salt) values('sun', '123', null);
insert into user_roles(username, role_name) values('sun', 'role1');
insert into user_roles(username, role_name) values('sun', 'role2');
